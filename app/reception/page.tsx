...
export default function ReceptionPage() {
  return (
    <main className="min-h-screen flex flex-col bg-wedding-secondary">
      ...
      <section className="w-full bg-white py-20">
        <div className="max-w-2xl mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-serif text-wedding-accent mb-4">
              Join Our Celebration
            </h2>
            <div className="w-24 h-1 bg-wedding-primary mx-auto my-6"></div>
            <p className="text-lg text-wedding-accent mb-8">
            ...
            <Link
              href="/reception/rsvp"
              className="inline-block bg-wedding-primary text-white px-8 py-3 rounded-lg font-semibold hover:bg-wedding-accent transition-colors duration-200 shadow-lg hover:shadow-xl"
            >
              RSVP Now
            </Link>
          </div>
